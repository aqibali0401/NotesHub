        ...
        <div class="main_menu" style="background-color: #1F2338;">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand " href="?page=hom"><img src="img/logo.png" alt=""
                            style="max-width: 70%;"></a>
                    <button style="margin-bottom: 0%;" class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            <li class="nav-item"><a class="nav-link" href="?page_bl=home">Home</a></li>
                            <li class="nav-item"><a class="nav-link" href="?page_bl=dashbord"> Dashboard </a></li>
                            <li class="nav-item"><a class="nav-link" href="?page_bl=top">Top Contributors</a></li>
                            <li class="nav-item"><a class="nav-link" href="?page_bl=contact">Contact</a></li>
                            <li class="nav-link" style="border: 2px solid white; border-radius: 5px; background-color: white; padding: 6px 12px;">
                                <?php if (!$session_id) { ?>
